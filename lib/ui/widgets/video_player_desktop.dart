...
import 'package:pstube/ui/widgets/controls_wrapper_desktop.dart';
...
class _VideoPlayerDesktopState extends State<VideoPlayerDesktop>
  ...
  ControlsDesktopData data(BuildContext context, {bool isFullscreen = false}) =>
      ControlsDesktopData(
        showWindowControls:
            !isFullscreen && (context.isMobile || widget.isCinemaMode.value),
        showTimeLeft: false,
  ...
  Widget videoWidget(BuildContext context, {bool isFullScreen = false}) =>
      Video(
        showControls: false,
        ...
        pageBuilder: (_, __, ___) => Scaffold(
          body: Container(
            ...
            child: ControlsWrapperDesktop(
              ...
              child: videoWidget(context, isFullScreen: true),
            ),
          ),
        ),
      ),
